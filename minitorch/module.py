...
class Module:
    ...
    def named_parameters(self) -> Sequence[Tuple[str, Parameter]]:
        ...
        for name, param in self._parameters.items():
            collection.append((name, param))

        for module_name, module in self._modules.items():
            for child_name, param in module.named_parameters():
                collection.append((f"{module_name}.{child_name}", param))
    ...
    def parameters(self) -> Sequence[Parameter]:
        ...
        Returns
        -------
            Sequence: A sequence of `Parameter` objects from this module and all its descendants.
